...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Orden de Servicio - EduBWeb');
});
...
$('select[name="orden_proveedor"]').on('change', function() {
    ...
    if (provid != "") {
        ...
        $.post(
            "../../modules/proveedores/consultar-proveedor.php", { FILTER: provid },
            function(data) {
...
$("#btn-select-orden").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/ordenes/consultar-orden.php", { TIPO_ORDEN: "SERVICIO", FILTER: DATA_ID, ESTADO: "ALL" },
            function(data) {
                ...
                $.post(
                    "../../modules/ordenes/consultar-detalle-orden.php", { IDORDEN: codigo_idorden },
                    function(data) {
...
$("#btn-delete-orden").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/ordenes/eliminar-orden.php", { ID_ORDER: id_val },
                    function(data) {
                        if (data == true) {
                            $('input[name="orden_nro"]').focus();
                            tbl_prodordcompra.clear().draw();
