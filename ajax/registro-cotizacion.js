...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Registro de Cotización - EduBWeb');
});
...
$("#btn-select-cotizacion").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/cotizaciones/consultar-cotizacion.php", { FILTER: DATA_ID, ESTADO: "ALL" },
            function(data) {
...
$("#btn-anular-cotizprod").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/cotizaciones/anular-cotizacion.php", { ID_COTIZ: id_val },
                    function(data) {
                        if (data == true) {
                            $('input[name="cotizacion_fecha"]').focus();
                            tbl_prodcotiz.clear().draw();
