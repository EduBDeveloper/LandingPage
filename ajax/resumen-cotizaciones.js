...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Resumen de Cotizaciones - EduBWeb');
});
...
$.post(
    "../../modules/cotizaciones/consultar-cotizacion.php", { FILTER: "ALL", ESTADO: "ALL" },
    function(data) {
...
$("#btn-buscar").click(function() {
    ...
    if (cotiz_nroo != "" || cotiz_client != "" || (cotiz_fini != "" && cotiz_ffin != "")) {
        ...
        $.post(
            "../../modules/cotizaciones/filtrar-cotizaciones.php", { cotiz_nroo: cotiz_nroo, cotiz_client: cotiz_client, cotiz_fini: cotiz_fini, cotiz_ffin: cotiz_ffin },
            function(data) {
                tbl_cotizaciones.clear().draw();
                data_cotiz = JSON.parse(data);
                for (i = 0; i < data_cotiz.length; i++) {
    ...
    callback: function(key, options) {
        ...
        if (tbl_data.length > 0) {
            ...
            switch (accion) {
                ...
                case "delete":
                    $.post(
                        "../../modules/cotizaciones/anular-cotizacion.php", { ID_COTIZ: row_id },
                        function(data) {
                            if (data == true) {
                                $.post(
                                    "../../modules/cotizaciones/consultar-cotizacion.php", { FILTER: "ALL", ESTADO: "ALL" },
