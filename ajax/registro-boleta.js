...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Registro de Boleta - EduBWeb');
});
...
$("#btn-select-factura").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/facturacion/consultar-boleta.php", { FILTER: DATA_ID, ESTADO: "ALL" },
            function(data) {
                ...
                if (data_json.length > 0) {
                    ...
                    $.post(
                        "../../modules/facturacion/consultar-detalle-boleta.php", { FAC_ID: codigo_idfac },
                        function(data) {
...
$("#btn-anular-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'RECEIPT', ID_DOC: id_val, ESTADO_DOC: 2 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
$("#btn-pendiente-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'RECEIPT', ID_DOC: id_val, ESTADO_DOC: 3 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
$("#btn-cancelar-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'RECEIPT', ID_DOC: id_val, ESTADO_DOC: 4 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
function buscarCorrelativo() {
    ...
    $.post("../../modules/facturacion/obtener-correlativo-doc.php", { TIPO_DOC: "RECEIPT", SERIE: serieFactura }, function(data) {
        if (data != "" && data != null) {
