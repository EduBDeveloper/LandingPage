...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Registro de Factura - EduBWeb');
});
...
$('input[name="facturacion_valcliente"]').autocomplete({
    ...
    select: function(event, ui) {
        ...
        if (ui.item.id != "" && ui.item.id != null) {
            $.post(
                "../../modules/clientes/consultar-cliente.php", { FILTER: ui.item.id },
                function(data) {
...
$.post(
    "../../modules/productos/listar-productos-xprov.php", { ESTADO: 1 },
    function(data) {
...
$('select[name="facturacion_producto"]').on("change", function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/productos/consultar-productos.php", { FILTER: DATA_ID, ESTADO: "1" },
            function(data) {
                var mydata = JSON.parse(data);
...
$("#btn-add-prodtofactura").click(function() {
    ...
    if (idprod != "" && cantidad != "" && cantidad > 0) {
        ...
        new_igv = importe_totactual * 0.10;
...
$("#btn-select-factura").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/facturacion/consultar-factura.php", { FILTER: DATA_ID, ESTADO: "ALL" },
            function(data) {
                ...
                if (data_json.length > 0) {
                    ...
                    $.post(
                        "../../modules/facturacion/consultar-detalle-factura.php", { FAC_ID: codigo_idfac },
                        function(data) {
...
$("#btn-select-cotizacion").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post("../../modules/cotizaciones/consultar-cotizacion.php", { FILTER: DATA_ID, ESTADO: "ALL" }, function(data) {
            ...
            $.post("../../modules/cotizaciones/consultar-detalle-cotizacion.php", { IDCOTIZ: codigo_idcotiz }, function(data) {
                $('select[name="facturacion_producto"]').val("");
                $('select[name="facturacion_producto"]').trigger("change");
                $('input[name="facturacion_proddesc"]').val("");
                $('input[name="facturacion_prodprecio"]').val("");
...
$("#btn-anular-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'INVOICE', ID_DOC: id_val, ESTADO_DOC: 2 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
$("#btn-pendiente-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'INVOICE', ID_DOC: id_val, ESTADO_DOC: 3 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
$("#btn-cancelar-factura").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'INVOICE', ID_DOC: id_val, ESTADO_DOC: 4 },
                    function(data) {
                        if (data == true) {
                            postCambioEstado();
...
function buscarCorrelativo() {
    ...
    $.post("../../modules/facturacion/obtener-correlativo-doc.php", { TIPO_DOC: "INVOICE", SERIE: serieFactura }, function(data) {
        if (data != "" && data != null) {
