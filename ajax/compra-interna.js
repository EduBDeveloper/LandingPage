...
$(document).ready(function() {
    ...
    $(document).prop('title', 'Compra Interna - EduBWeb');
});
...
$("#btn-select-orden").click(function() {
    ...
    if (DATA_ID != "" && DATA_ID != null) {
        ...
        $.post(
            "../../modules/compras/consultar-compra.php", { TIPO_ORDEN: "COMPRA", FILTER: DATA_ID, ESTADO: "ALL" },
            function(data) {
                ...
                $.post(
                    "../../modules/compras/consultar-detalle-compra.php", { IDORDEN: codigo_idorden },
                    function(data) {
...
$("#btn-delete-orden").click(function() {
    ...
    if (id_val != "" && id_val != null) {
        Swal.fire({
            ...
            if (result.value) {
                $.post(
                    "../../modules/compras/eliminar-compra.php", { ID_ORDER: id_val },
                    function(data) {
                        if (data == true) {
                            $('input[name="orden_nro"]').focus();
                            tbl_prodordcompra.clear().draw();
