$(document).ready(function() {
    ...
    $(document).prop('title', 'Resumen de Notas de Crédito - EduBWeb');
});
            ...
            switch (action) {
                ...
                case "vigente":
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.post(
                                "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'CREDIT_NOTE', ID_DOC: row_id, ESTADO_DOC: 1 },
                                function(data) {
                                    if (data) {
                                        listarDocumentos();
                                        $.Notification.notify(
                ...
                case "anulado":
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.post(
                                "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'CREDIT_NOTE', ID_DOC: row_id, ESTADO_DOC: 2 },
                                function(data) {
                                    if (data) {
                                        listarDocumentos();
                                        $.Notification.notify(
                ...
                case "pendiente":
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.post(
                                "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'CREDIT_NOTE', ID_DOC: row_id, ESTADO_DOC: 3 },
                                function(data) {
                                    if (data) {
                                        listarDocumentos();
                                        $.Notification.notify(
                ...
                case "cancelado":
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.post(
                                "../../modules/facturacion/cambiar-estado-doc.php", { TIPO_DOC: 'CREDIT_NOTE', ID_DOC: row_id, ESTADO_DOC: 4 },
                                function(data) {
                                    if (data) {
                                        listarDocumentos();
                                        $.Notification.notify(
