            ...
            <div class="row mb-0">
                <div class="col-md-12">
                    <div class="m-0 text-dark text-center text-lg">
                        <i class="fas fa-file-invoice"></i>&nbsp;&nbsp;Adquirir Productos
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <select class="form-control select2" name="facturas_listado">
                                        <option value="">No se han encontrado pedidos</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <button type="button" id="btn-select-factura" class="form-control btn btn-primary">Seleccionar Pedido</button>
                            </div>
                        </div>
                    </div>
                    <div id="col-btn-nuevafac" class="col-md-6">
                        <button type="button" id="btn-nuevafac" class="btn btn-primary btn-block"><i class="fa fa-plus fa-1x"></i>&nbsp;&nbsp;<font>Registrar nueva compra</font></button>
                    </div>
                </div>
                                ...
                                <div class="col-md-8 col-lg-4">
                                    <div class="form-group">
                                        <select class="form-control select2" name="">
                                            <option value="">No se han encontrado presupuestos</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4">
                                    <button type="button" id="btn-select-cotizacion" class="form-control btn btn-primary">Seleccionar Presupuesto</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="facturacion_series">
                                                    ...
                                                    <option value="FNC2">Deposito 1</option>
                                                    <option value="BNC1">Deposito 2</option>
                                                    <option value="BNC2">Deposito 3</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                                    ...
                                    <select name="facturacion_motivo_nc" class="form-control select2" required>
                                        ...
                                        <option value="ANULACION">Sin Comentarios</option>
                                        <option value="CORRECCION">Entregar en las oficinas del cliente/option>
                                        <option value="DEVOLUCION_TOTAL">Retirar del distribuidor</option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div id="col-btn-save-facturaprod" class="col-md-12">
                                    <button type="submit" id="btn-save-facturaprod" class="btn btn-success btn-block"><i class="fa fa-save fa-1x"></i>&nbsp;&nbsp;<font>Grabar Compra</font></button>
                                </div>
                                <div id="col-btn-anular-factura" class="col-md-4">
                                    <button type="button" id="btn-anular-factura" class="btn btn-danger btn-block"><i class="fa fa-minus-circle fa-1x"></i>&nbsp;&nbsp;<font><b>Anular</b> Compra</font></button>
                                </div>
