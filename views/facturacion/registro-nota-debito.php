            ...
            <div class="row mb-0">
                <div class="col-md-12">
                    <div class="m-0 text-dark text-center text-lg">
                        <i class="fas fa-file-invoice"></i>&nbsp;&nbsp;Nota de Debito
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    <select class="form-control select2" name="facturas_listado">
                                        <option value="">No se han encontrado ND</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <button type="button" id="btn-select-factura" class="form-control btn btn-primary">Seleccionar ND</button>
                            </div>
                        </div>
                    </div>
                    <div id="col-btn-nuevafac" class="col-md-6">
                        <button type="button" id="btn-nuevafac" class="btn btn-primary btn-block"><i class="fa fa-plus fa-1x"></i>&nbsp;&nbsp;<font>Nueva nota de Debito</font></button>
                    </div>
                </div>
                <form id="FRM_INSERT_FACTURA" method="post" action="<?php echo $functions->direct_sistema(); ?>/modules/facturacion/insert-nota-debito.php" enctype="multipart/form-data">
                    <input type="hidden" name="id_factura">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card-title">Datos de Nota de Debito</div>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>N° Nota de Debito</label>
                                                <input type="text" class="form-control" placeholder="Correlativo de ND" name="facturacion_nro" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="facturacion_valcliente" class="form-control" placeholder="Nombre de Proveedor" required>
                                    </div>
                                    <input type="hidden" name="facturacion_cliente">
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Fecha de Nota de Debito</label>
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                            		<label>Motivo de Nota de Debito</label>
                                    <select name="facturacion_motivo_nc" class="form-control select2" required>
                                        ...
                                        <option value="CORRECCION">Corrección por error en la descripción</option>
                                      	<option value="DEVOLUCION_ITEM">Correcion por error en la cantidad</option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div id="col-btn-save-facturaprod" class="col-md-12">
                                    <button type="submit" id="btn-save-facturaprod" class="btn btn-success btn-block"><i class="fa fa-save fa-1x"></i>&nbsp;&nbsp;<font>Grabar nota de Debito</font></button>
                                </div>
                                <div id="col-btn-anular-factura" class="col-md-4">
                                    <button type="button" id="btn-anular-factura" class="btn btn-danger btn-block"><i class="fa fa-minus-circle fa-1x"></i>&nbsp;&nbsp;<font><b>Anular</b> Nota de Debito</font></button>
                                </div>
